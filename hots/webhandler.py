# based on mongrel2-1.5/examples/python/mongrel2/handler.py

import zmq
import time
from hots.webrequest import Request
import json
...
class Connection(object):
    ...
    def __init__(self, sender_id, wsub, wpub):
        self.sender_id = sender_id
        self.reqs = wsub
        self.resp = wpub
        self.resp.setsockopt(zmq.IDENTITY, sender_id)
